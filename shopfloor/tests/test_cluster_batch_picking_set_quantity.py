...
class ClusterBatchPickingSetQuantityCase(ClusterBatchPickingCommonCase):
    ...
    def _test_set_quantity(self, response_expected, picking_batch_id, move_line_id, location_id, barcode, qty):
    ...
    def test_set_quantity_wrong_location(self):
